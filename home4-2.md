...
| Вопрос  | Ответ |
| ------------- | ------------- |
| Какое значение будет присвоено переменной `c`?  | unsupported operand type(s) for +: 'int' and 'str', т.к переменные имеют разные типы |
...
```
$ ./test.py
C:/Users/ДНС/Desktop/devops-netology/devops-netology_clone/123.text
C:/Users/ДНС/Desktop/devops-netology/devops-netology_clone/test.py
